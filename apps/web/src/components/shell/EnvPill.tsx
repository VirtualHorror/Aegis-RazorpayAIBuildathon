...
export function EnvPill({ system }: { system: SystemInfo | null }) {
  ...
  return (
    <span className="inline-flex h-7 items-center gap-1 rounded-full border border-border bg-surface px-2.5 font-mono text-[11px] text-fg-muted" title="Environment · every outbound effect is simulated">
      {env} · SIM
    </span>
  );
}
